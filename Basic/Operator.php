...
var_dump($i === $j);
echo "$i === $j --> identical <br>";

var_dump($i != $j);
echo "$i != $j --> not equal <br>";
var_dump($i != $j);
echo "$i <> $j --> not equal <br>";
var_dump($i !== $j);
echo "$i !== $j --> not identical <br>";

var_dump($i > $j);
echo "$i > $j --> greater then <br>";
var_dump($j < $i);
echo "$j < $i --> less then  <br>";
var_dump($i >= $j);
echo "$i >= $j --> greater then equal to <br>";
var_dump($j <= $i);
echo "$j <= $i --> less then equal to <br>";
...
var_dump($a >= 150 && $b <= 100); //10 >= 150 && 20 <= 100
echo '<br>';
var_dump($a == 70 || $b != 30); //10 == 70 || 20 != 30 //false ||true //true
echo '<br>';
